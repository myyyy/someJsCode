...
(function(b,f){
    jPlayerPlaylist=function(a,c,d,initInfo){
        var e=this;
        this.current=0;
        ...
        this._createItemHandlers(c,initInfo);
    ...
    jPlayerPlaylist.prototype={
        ...
        option:function(a,b){
            ...
            this.options.playlistOptions[a]=b;switch(a){
                ...
                break;
                case "itemClass":case "freeGroupClass":case "freeItemClass":case "removeItemClass":this._refresh(!0),this._createItemHandlers(c,initInfo)
            }
            return this
        },
        _init:function(){
        ...
        _createListItem:function(a){
            var c=this,d="<li><div><input type='hidden' id='txtid' value='"+a.id+"'/><input type='hidden' id='txtpraisenum' value='"+a.praisenum+"'/><input type='hidden' id='txtreshipnum' value='"+a.reshipnum+"'/><input type='hidden' id='txtbrowsenum' value='"+a.browsenum+"'/>";
            ...
            d+="<a href='javascript:;' class='"+this.options.playlistOptions.itemClass+"' tabindex='1' title='"+a.alt+"'>"+a.title+(a.artist?" <span class='jp-artist'>by "+a.artist+"</span>":"")+"</a>";
            d+="</div></li>";
            return d
        },
        _createItemHandlers:function(data,initInfo){
            var a=this;
            b(this.cssSelector.playlist+" a."+this.options.playlistOptions.itemClass).die("click").live("click",function(){
                var c=b(this).parent().parent().index();
                a.current+parseInt(objdata.num)!==c?a.play(c+parseInt(objdata.num)):b(a.cssSelector.jPlayer).jPlayer("play");
                b(this).blur();
                initInfo(data[c+parseInt(objdata.num)].id,data[c+parseInt(objdata.num)].alt);
                return!1
            });
        ...
        add:function(a,c){
            ...
            if(a===f)return this._initPlaylist([]),this._refresh(function(){
                ...
                if(0<=a&&a<this.playlist.length)
                    this.removing=!0,b(this.cssSelector.playlist+" li:nth-child("+(a+1)+")").slideUp(this.options.playlistOptions.removeTime,function(){
                        b(this).remove();
                        if(c.shuffled){
                            var d=c.playlist[a];
            ...
            next:function(){
                ...
                var d=this;a===f&&(a=!this.shuffled);
