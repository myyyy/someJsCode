...
(function ($, undefined) {
    ...
    jPlayerPlaylist = function (cssSelector, playlist, options) {
        ...
        this.cssSelector = $.extend({}, this._cssSelector, defaultobj, cssSelector); // Object: Containing the css selectors for jPlayer and its cssSelectorAncestor
        this.options = $.extend(true, {}, this._options, defaultobj, options); // Object: The jPlayer constructor options for this playlist and the playlist options
        ...
        this.options.repeat = function (event) {
            self.loop = self.loop ? self.loop : event.jPlayer.options.loop;
        };
        ...
        $(this.cssSelector.jPlayer).bind($.jPlayer.event.ended, function (event) {
            self.next(self.options.nextPreCallback);
        });
        ...
        $(this.cssSelector.previous).click(function () {
            self.previous(self.options.nextPreCallback);
            $(this).blur();
            return false;
        });
    ...
    jPlayerPlaylist.prototype = {
        ...
        next: function (nextPreCallback) {
            var index = (this.current + 1 < this.playlist.length) ? this.current + 1 : 0;
            nextPreCallback(index,'next');
            if (this.loop) {
        ...
        previous: function (nextPreCallback) {
            var index = (this.current - 1 >= 0) ? this.current - 1 : this.playlist.length - 1;
            nextPreCallback(index, 'pre');
